 ...
 * @author Abbas Zaheer
 */
public class EditTeacherWindow extends javax.swing.JFrame {

    /**
     * Creates new form EditTeacherWindow
     */
    String teacherID;
    public EditTeacherWindow(String id) {
        ...
        for (Teacher tea : Admin.getTeachers()) {
            if(tea.getUserId() == teacherID){
                
                TF_FirstName.setText(tea.getFirstName());
                TF_LastName.setText(tea.getLastName());
                TF_Username.setText(teacherID);
                JC_Gender.setSelectedItem(tea.getGender());
                JC_acStatus.setSelectedItem(tea.getAccountStatus());
                break;
            }
        }
    }
        ...
        else
        {
            ...
            for (Teacher tea : Admin.getTeachers()) {
                if(tea.getUserId() == teacherID){
                    ...
                    if(!tea.getFirstName().equals(TF_FirstName.getText())
                        || !tea.getLastName().equals(TF_LastName.getText())
                        ||!tea.getUserId().equals(TF_Username.getText())
                        || !tea.getGender().equals(JC_Gender.getSelectedItem().toString())
                        || !tea.getAccountStatus().equals(JC_acStatus.getSelectedItem().toString()))
                    {

                        tea.setFirstName(TF_FirstName.getText());
                        tea.setLastName(TF_LastName.getText());
                        tea.setUserId(TF_Username.getText());
                        tea.setGender(JC_Gender.getSelectedItem().toString());
                        tea.setAccountStatus(JC_acStatus.getSelectedItem().toString());
