 ...
 * @author Abbas Zaheer
 */
public class StudentRoadMapWindow extends javax.swing.JFrame {

    /**
     * Creates new form StudentRoadMap
     */
    ...
    public StudentRoadMapWindow(Student stu) {
        initComponents();
    ...
    private void BTN_BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_BackActionPerformed
            ...
            new StudentMenuWindow((Student) student).setVisible(true);
            this.dispose();
    ...
    private void showLeftTable(){
        ...
        // Column Names 
        String[] columnNames = { "ID", "Title", "Credit Hour", "Type", "Category"}; 
